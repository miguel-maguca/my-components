...
import * as SmartRating from "./SmartRating.stories.tsx";

<Meta of={SmartRating} title="Button" />

# SmartRating

SmartRating component with different props.

#### Example

<Canvas of={SmartRating.Primary} />

## Usage

```ts
import {SmartRating} from "sld-ui";

const Example = () => {
  return (
      <SmartRating
        testIdPrefix="some-test-id-prefix"
        title="Smart Rating"
        theme="primary"
        disabled={false}
      />
